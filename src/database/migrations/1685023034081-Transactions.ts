...
export class Transactions1685023034081 implements MigrationInterface {
  name = 'Transactions1685023034081';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "conductedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "groupId" integer NOT NULL, "incomingAccountId" integer NOT NULL, "outgoingAccountId" integer NOT NULL, "incomingAmount" bigint, "outgoingAmount" bigint, "description" character varying NOT NULL, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
